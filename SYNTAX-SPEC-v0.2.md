# wiremd Syntax Specification v0.2
...
New features will increment minor version (0.2 → 0.3)
Syntax additions should be backwards compatible where possible

---

**Specification Status:** Implemented and maintained for v0.2
